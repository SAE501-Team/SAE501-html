            ...
            <div class="">
              ...
              <table class="table table-bordered">
                ...
                <span class="title_box">
                  ...
                  {if $input.search}
                    <th>
                      <a href="#" id="show_checked" class="btn btn-default"><i class="icon-check-sign"></i> {l s='Show Checked'  mod='blog'}</a>
                      &nbsp;
                      <a href="#" id="show_all" class="btn btn-default"><i class="icon-check-empty"></i> {l s='Show All'  mod='blog'}</a>
                    </th>
                  {/if}
                  <th>
                    <span class="title_box">
                      {if $input.search}
                        <input type="text" class="search_checkbox_table" placeholder="{l s='search...'  mod='blog'}">
                      {/if}
                    </span>
                  </th>
                </tr>
