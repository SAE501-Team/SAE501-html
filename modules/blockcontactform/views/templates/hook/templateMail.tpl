    ...
    <div style=" width: 633px;
        ...
        <div style="margin-top: 25px;
            ...
            <span class="title" style=" font-weight:normal;
                                    ...
                                    line-height:25px
                                    ">
                {l s='Contact Form' mod='blockcontactform'}
            </span><br/>
        </div>
        <div style="margin-top: 15px;
            ...
            ">{l s='Report' mod='blockcontactform'}</div>
            {if $name}
                <div style="color: #000000;
                    ...
                    <div style="width: 119px;
                            ...
                            min-height: 20px;
                            width: 200px;
                            ">{l s='Customer name' mod='blockcontactform'}</div>
            ...
            {if $email}
                <div style="color: #000000;
                    ...
                    <div style="width: 119px;
                            ...
                            min-height: 20px;
                            width: 200px;
                            ">{l s='Customer email' mod='blockcontactform'}</div>
                    <div style="width: 370px;
                            color: #000000;
                            float: left;
                            border-bottom: 1px solid #b1b0af;
            ...
            {if $phone}
                <div style="color: #000000;
                    ...
                    <div style="width: 119px;
                            ...
                            min-height: 20px;
                            width: 200px;
                            ">{l s='Phone number' mod='blockcontactform'}</div>
                    <div style="width: 370px;
                            color: #000000;
                            float: left;
                            border-bottom: 1px solid #b1b0af;
            ...
            {if $subject}
                <div style="color: #000000;
                    ...
                    <div style="width: 119px;
                            ...
                            min-height: 20px;
                            width: 200px;
                            ">{l s='Subject Heading' mod='blockcontactform'}</div>
                    <div style="width: 370px;
                            color: #000000;
                            float: left;
                            border-bottom: 1px solid #b1b0af;
            ...
            {if $file_attachment}
                <div style="color: #000000;
                    ...
                    <div style="width: 119px;
                            ...
                            min-height: 20px;
                            width: 200px;
                            ">{l s='Attach File' mod='blockcontactform'}</div>
                    <div style="width: 370px;
                            color: #000000;
                            float: left;
                            border-bottom: 1px solid #b1b0af;
            ...
            {if $comment}
                <div style="color: #000000;
                    ...
                    <div style="width: 119px;
                            ...
                            min-height: 65px;
                            width: 200px;
                            ">{l s='Message' mod='blockcontactform'}</div>
                    <div style="width: 370px;
                            color: #000000;
                            float: left;
                            font-size: 17px;
