    ...
    <div style=" width: 633px;
        ...
        <div style="margin-top: 25px;
            ...
            <span class="title" style=" font-weight:normal;
                                    ...
                                    line-height:25px
                                    ">
                {l s='Request a CallBack' mod='freecall'}
            </span><br/>
        </div>
            ...
            {if $phone}
                <div style="color: #000000;
                    ...
                    <div style="width: 119px;
                            ...
                            min-height: 20px;
                            width: 200px;
                            ">{l s='Phone Number' mod='freecall'}</div>
            ...
            {if $email}
                <div style="color: #000000;
                    ...
                    <div style="width: 119px;
                            ...
                            min-height: 20px;
                            width: 200px;
                            ">{l s='Email address' mod='freecall'}</div>
                    <div style="width: 370px;
                            color: #000000;
                            float: left;
                            border-bottom: 1px solid #b1b0af;
