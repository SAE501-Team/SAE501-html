...
<div id="form-container">
    <img src="{$smarty.const._MODULE_DIR_}userrecommandation/views/img/chevreReco.png" alt="Ouvrir le formulaire">
</div>

<!-- Formulaire caché -->
<div id="form-content">
    <form action="{$link->getModuleLink('userrecommandation', 'postprocess')}" method="post">
        ...
        <div class="form-group">
            ...
            <select name="gout_prefere" class="form-control">
                ...
                <option value="fraise" {if $gout_prefere == 'fruits rouges'}selected{/if}>Fruits rouges</option>
            </select>
        </div>
