...
<div id="search_filters">
    <h4 class="text-uppercase h6 hidden-sm-down search_filters_title">{l s='Filter By' d='Shop.Theme.Actions'}</h4>
        ...
        {foreach from=$facets item="facet"}
            ...
            {if $facet.displayed}
                <section class="facet">
                    ...
                    <span onclick="" class="h6 facet-title hidden-sm-down {if !$_collapse} active{/if}">{$facet.label}</span>
