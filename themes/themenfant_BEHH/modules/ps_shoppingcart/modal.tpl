        ...
        <div class="row">
          <div class="col-md-5 divide-right">
            <div class="row">
              ...
              <div class="col-md-6">
                <h6 class="h6 product-name font-adlam !text-be-vert">{$product.name}</h6>
          ...
          <div class="col-md-7">
            <div class="cart-content">
              ...
              {else}
                <p class="product-total !text-be-vert"><span class="label">{$cart.totals.total.label}&nbsp;{if $configuration.taxes_enabled && $configuration.display_taxes_label}{$cart.labels.tax_short}{/if}</span>&nbsp;<span class="value">{$cart.totals.total.value}</span></p>
              {/if}
