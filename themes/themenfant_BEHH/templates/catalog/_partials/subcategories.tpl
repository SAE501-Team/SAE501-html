...
<contact@prestashop.com>
  * @copyright Since 2007 PrestaShop SA and Contributors * @license
  ...
  {if !empty($subcategories)} {if (isset($display_subcategories) &&
  $display_subcategories eq 1) || !isset($display_subcategories) }
  <div id="subcategories" class="card card-block">
    ...
    <ul class="subcategories-list justify-center font-adlam">
      {foreach from=$subcategories item=subcategory} {if $subcategory.name !=
      "Magic Blend" && $subcategory.name != "Mélange Magique"}
      <li>
        ...
        <div class="subcategory-image">
          ...
          >
            <picture>
              ...
              <source
                srcset="{$subcategory.image.large.sources.avif}"
                type="image/avif"
              />
              {/if} {if !empty($subcategory.image.large.sources.webp)}
              <source
                srcset="{$subcategory.image.large.sources.webp}"
                type="image/webp"
              />
              {/if}
              <img
        ...
        <a
          class="subcategory-name col-span-2 sm:col-span-1 border-black border-3 transition-all ease-out duration-300 hover:bg-black flex items-center justify-center"
          href="{$subcategory.url}"
        >
