...
{else}
  ...
  <div class="form-group row {if !empty($field.errors)}has-error{/if}">
    <label class="col-md-3 form-control-label{if $field.required} required{/if} text-black font-adlam text-base group-focus-within:text-be-bleu" for="field-{$field.name}">
          ...
          {foreach from=$field.availableValues item="label" key="value"}
            <div class="radio-b">
              <input
                  ...
                  >
              <label class="radio-inline radio-b__label" for="field-{$field.name}-{$value}">
                <div class="radio-b__custom">
                  <span class="radio-b__custom-fill"></span>
                </div>
                <span class="radio-b__text">{$label}</span>
              </label>
            </div>
          {/foreach}
          </div>
      ...
      {elseif $field.type === 'password'}
        ...
        {block name='form_field_item_password'}
          <div class="input-group js-parent-focus">
            <input
              id="field-{$field.name}"
              class="form-control js-child-focus js-visible-password !bg-white !border-3 !border-black transition ease-out duration-500 hover:scale-[0.99] focus:!border-be-bleu focus:!outline-none"
              name="{$field.name}"
