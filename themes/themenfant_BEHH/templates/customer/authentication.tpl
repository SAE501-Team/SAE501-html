...
<contact@prestashop.com>
  * @copyright Since 2007 PrestaShop SA and Contributors * @license
  ...
  {extends file='page.tpl'} {block name='page_title'} {l s='Log in to your
  account' d='Shop.Theme.Customeraccount'} {/block} {block name='page_content'}
  ...
  <div class="no-account">
    <a
      ...
      class="text-be-rose hover:text-be-bleu transition ease-out duration-300"
    >
